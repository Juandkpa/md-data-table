...
(function (window, angular, undefined) {
  ...
  angular.module('md-table-pagination.html', []).run(['$templateCache', function($templateCache) {
    $templateCache.put('md-table-pagination.html',
      ...
      '  <div class="label labelSpecialOntrack">{{$pagination.label.rowsPerPage}}</div>\n' +
      '\n' +
      ...
      '\n' +
      '<div class="buttons">\n' +
      '  <div class="label labelSpecialOntrack">{{$pagination.min()}} - {{$pagination.max()}} {{$pagination.label.of}} {{$pagination.total}}</div>\n' +
      '\n' +
